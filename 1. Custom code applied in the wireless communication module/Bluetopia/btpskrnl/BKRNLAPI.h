...
#define BTPS_STRUCTURE_OFFSET(_x, _y)              (__INTADDR__((&((_x *)0)->_y)))
...
BTPSAPI_DECLARATION int BTPSAPI BTPS_QueryMemoryUsage(unsigned int *Used, unsigned int *Free, unsigned int *MaxFree);
