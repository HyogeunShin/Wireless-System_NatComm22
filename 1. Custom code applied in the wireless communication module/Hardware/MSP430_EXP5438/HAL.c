...
static void ConfigureBoardDefaults(void)
{
   ...
   //Additional initialization on UCA0 port
   //PORT 3, bits 4,5 are jumpered to other pins initially,
   //so these should be input, with pullup/pulldown resistors disabled
   //BUT the corresponding interrupt sources for PORT3 interrupts should
   //NOT be disabled, since there is IO interrupt on PORT3
